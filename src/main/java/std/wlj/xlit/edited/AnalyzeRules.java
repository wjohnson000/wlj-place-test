...
public class AnalyzeRules {
    ...
    public static void main(String...args) throws Exception {
        ...
        List<String> lines = UtilStuff.readFile(INPUT_FILE);
        ...
        System.out.println("=========================================================================================");
        kmManagesEn.entrySet().forEach(entry -> System.out.println(kmIndex.get(entry.getKey()) + "\t" + entry.getKey() + "\t" + UtilStuff.getUChars(entry.getKey()) + "\t" + entry.getValue()));
