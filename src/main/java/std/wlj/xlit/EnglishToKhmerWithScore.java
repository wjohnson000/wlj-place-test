...
public class EnglishToKhmerWithScore {

    final static String pathToFiles = "D:/xlit/km";
    final static String inputFile   = "en-to-km-names-good.txt";
    final static String outputFile  = "en-to-km-names-scored.txt";
...
//        System.out.println(Arrays.toString(extractXlit(jsonOO)));
        ...
        for (String fullName : names) {
            ...
            JSONObject jsonO = translate(nameChunks[0]);
...
//            System.out.println("Name: " + name + " --> " + response.getStatusLine());
    ...
    static String[] extractXlit(JSONObject jsonO) {
        ...
        if (data01.length() > 6) {
//            Double data06 = data01.getDouble(6);
            result[4] = String.valueOf(data01.get(6));
        }
