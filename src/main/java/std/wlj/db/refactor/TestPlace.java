...
public class TestPlace {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            SearchParameter param01 = SearchParameter.PlaceParam.createParam(4);
            SearchParameter param02 = SearchParameter.PlaceParam.createParam(9);
            SearchParameter param03 = SearchParameter.PlaceParam.createParam(555);
            params.addParam(param01).addParam(param02).addParam(param03);

            System.out.println(">>> Two places ...");
