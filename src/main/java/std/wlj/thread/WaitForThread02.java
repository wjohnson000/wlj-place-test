...
public class WaitForThread02 {

    private static WaitForThread02 onlyInstance = null;
    ...
    public static void startDbLoadManager() {
        if (onlyInstance == null) {
            onlyInstance = new WaitForThread02();
    ...
    public static void main(String... args) {
        WaitForThread02.startDbLoadManager();
    }
}
