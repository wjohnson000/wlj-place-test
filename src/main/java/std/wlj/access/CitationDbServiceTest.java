    ...
    public static void main(String... args) {
        ...
        try {
            ...
            for (CitationBridge citnB : citnBs) {
                System.out.println("ATTR: " + citnB.getCitationId() + "." + citnB.getPlaceRep().getRepId() + " :: " + citnB.getSourceRef() + " :: " + citnB.getDescription());
            }

            System.out.println("\nNEW..............................................\n");
            CitationBridge citnB01 = dbWService.createCitation(2, 463, 22, new Date(), "citn-desc", "citn-ref", "wjohnson000");
            System.out.println("ATTR: " + citnB01.getCitationId() + "." + citnB01.getPlaceRep().getRepId() + " :: " + citnB01.getSourceRef() + " :: " + citnB01.getDescription());
            ...
            System.out.println("ATTR: " + citnB02.getCitationId() + "." + citnB02.getPlaceRep().getRepId() + " :: " + citnB02.getSourceRef() + " :: " + citnB02.getDescription());
