...
public class PlaceAndRepAndAttrTest {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            AttributeBridge attrB01 = dataService.createAttribute(repId, 433, 2001, null, "fr", "attr-value-01", null, null, null, null, fakeUser, null);
            AttributeBridge attrB02 = dataService.createAttribute(repId, 433, 2002, null, "fr", "attr-value-02", null, null, null, null, fakeUser, null);
            AttributeBridge attrB03 = dataService.createAttribute(repId, 433, 2003, null, "fr", "attr-value-03", null, null, null, null, fakeUser, null);

            dataService.deleteAttribute(attrB02.getAttributeId(), repId, fakeUser, null);

            AttributeBridge attrB04 = dataService.createAttribute(repId, 433, 2004, null, "fr", "attr-value-04", null, null, null, null, fakeUser, null);

            dataService.deleteAttribute(attrB03.getAttributeId(), repId, fakeUser, null);

            AttributeBridge attrB05 = dataService.createAttribute(repId, 433, 2005, null, "fr", "attr-value-05", null, null, null, null, fakeUser, null);
            AttributeBridge attrB06 = dataService.createAttribute(repId, 433, 2006, null, "fr", "attr-value-06", null, null, null, null, fakeUser, null);
            AttributeBridge attrB07 = dataService.createAttribute(repId, 433, 2007, null, "fr", "attr-value-07", null, null, null, null, fakeUser, null);
