...
public class FixSolr1442484 {

    public static void main(String... args) throws PlaceDataException {
        SolrConnection solrConn = SolrManager.awsProdConnection(false);

        PlaceRepDoc xDoc = lookupDocument(solrConn, "1442484");
//        lookupDocument(solrConn, "8159283");
//        lookupDocument(solrConn, "8159284");
//        lookupDocument(solrConn, "8159324");
//        lookupDocument(solrConn, "8159327");
//        lookupDocument(solrConn, "8159328");
//        lookupDocument(solrConn, "8159329");
//        lookupDocument(solrConn, "8159330");
