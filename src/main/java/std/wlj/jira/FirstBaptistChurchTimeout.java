 ...
 *
 */
public class FirstBaptistChurchTimeout {
    ...
    public static void main(String... args) throws PlaceDataException, IOException {
        ...
        doIt(placeService, 0, "en", "First Baptist Church, Reading, Lyon County, Kansas");
        doIt(placeService, 0, "en", "First Baptist Church, Reading, Lyon County, Kansas - Rev. J.S. Bunch");
