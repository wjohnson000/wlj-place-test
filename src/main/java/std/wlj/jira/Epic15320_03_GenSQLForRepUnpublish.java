 ...
 *
 */
public class Epic15320_03_GenSQLForRepUnpublish {

    static final String baseDir      = "C:/temp";
    static final String repFile      = "db-place-rep-all.txt";
    static final String repUnpubFile = "e15320-rep-unpublish.sql";
    ...
    static final String[] beginSQL = {
        ...
        "BEGIN",
        "  INSERT INTO transaction(tran_id, create_ts, create_id) VALUES(tranx_id, now(), 'system-unpublish-reps');"
    };
    ...
    static String updateRepSQL(String[] data) {
        ...
        buff.append(", ").append(numericData(data[9]));
        buff.append(", ").append(characterData(data[10]));
        buff.append(", ").append(booleanData("FALSE"));  // Set the "pub_flag" to FALSE
