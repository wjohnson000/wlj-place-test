...
/**
 * Implement basic GET, POST, PUT and DELETE functionality using Apache's "HttpClient" classes, and the pooling connection
 * manager to re-use connections.
 * <p/>
 * NOTE: the {@link CloseableHttpClient} instances are NOT closed, since they would in turn close the underlying
 * connection manager!
 * <p/>
 * NOTE: Care would need to be taken when determining the best numbers for the pooling parameters.
 * 
 * @author wjohnson000
 *
 */
public class ApacheClientPooled {
     ...
     * @return
     */
    public static ApacheClientPooled getDefault() {
     ...
     * @return
     */
    public static ApacheClientPooled getDefault(String contentType, Map<String, String> headers) {
        ApacheClientPooled client = new ApacheClientPooled();
