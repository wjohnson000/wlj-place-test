 ...
 *
 */
public class FindAllNamesPagedIterator {
    ...
    public static void main(String...args) throws Exception {
        ...
        SimpleStatement statement = SimpleStatement.builder("SELECT * FROM hhs.name").setPagingState(null).build();
        ResultSet rset = cqlSession.execute("SELECT * FROM hhs.name");
