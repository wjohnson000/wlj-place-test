...
public class PrintAll {
    ...
    static void printAll(Session session) {
        ...
        for (Row row : rset) {
            ...
            System.out.println("        updt: " + row.getTimestamp("last_updated") + " --> " + row.getTimestamp("last_updated").getClass().getName());
            ...
            System.out.println("        rslt: " + row.getList("results", UDTValue.class));
        }
    }
}
