...
public class AnalysisShimSyncThreadLocal {
    ...
    protected static final Logger logger = new Logger(AnalysisShimSyncThreadLocal.class);
    ...
    private static ThreadLocal<CloseableHttpClient> httpClients =
