 ...
 *
 */
public class RunInterpretationHiloHawaii {
...
//        PlaceService placeService = PlaceService.getInstance( new DefaultPlaceRequestProfile( null, solrService, null ) );
        ...
        doIt(placeInterpService, 0, "en", "Hilo", null, null, null);
        doIt(placeInterpService, 0, "en", "Hilo", "1939", null, null);
        doIt(placeInterpService, 0, "en", "Hilo", null, 328, null);
        doIt(placeInterpService, 0, "en", "Hilo", "1939", 328, null);
        doIt(placeInterpService, 0, "en", "Hilo", null, 10307401, null);
        doIt(placeInterpService, 0, "en", "Hilo", "1939", 10307401, null);
