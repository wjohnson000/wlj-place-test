 ...
 *
 */
public class RunInterpretationUSFederalJIRA7837 {
...
//        SolrService  solrService = SolrManager.awsBetaService(true);
        ...
        doIt(placeService, "en", "US Federal", false);
        doIt(placeInterpService, "en", "US Federal", false);
        doIt(placeInterpService, "en", "USFederal", false);
