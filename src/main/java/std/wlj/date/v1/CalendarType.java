...
public enum CalendarType {
  ...
  /**
   * Western calendar -- the generic calendar used in Western culture. It uses Gregorian calendar rules for Julian Day number 2299161 ( 15 Oct 1582) and later,
   * and Julian calendar rules for 2299160 and earlier.
   */
  WESTERN (1, "Western"),

   /**
   * Gregorian calendar -- introduced by Pope Gregory in 1582 to overcome defects in the Julian calendar, i.e. leap year calculations.
   */
  ...
  /**
   * A calendar used in France for a brief period following the revolution.
   */
  FRENCH_REPUBLICAN (9, "French Republican"),
