...
/**
 * @author Pete Blake Date: Apr 26, 2005
 *         <p/>
...
public class JapaneseCalendar extends CJKCalendar {
  ...
  public int firstGregorian() {
    //  The lunar calendar was abolished and the Gregorian Calendar introduced
    // in Meiji 5 (1872) when the 3rd day of the 12th month was declared to be
    // 1 January 1873. ("Japanese Chronological Tables", p.4 )
    // Our lunar tables end at Meiji 5.12.30. DateTokenUse Gregorian rules after that.
    //  We process any date before Meiji 6 (2405188) as lunar,
    // consequently, julian day numbers from 2405160 to 2405187, inclusive,
    // are ambiguous as to whether we used lunar or Gregorian rules.
