...
public class ManageAttributes {
    public static void main(String[] args) throws PlaceDataException {
        ...
        // typeId=1053 --> name
        AttributeDTO newAttr01 = new AttributeDTO(0, 9931104, 1019, 2010, "attr-value", 0);
        AttributeDTO creAttr01 = service.create(newAttr01, "wjohnson000");
        System.out.println("CreAttr: " + creAttr01.getId() + " ... " + creAttr01);

        AttributeDTO updAttr02 = new AttributeDTO(creAttr01.getId(), 9931104, 1019, 2012, "attr-value-new", 0);
        ...
        AttributeDTO updAttr03 = new AttributeDTO(creAttr01.getId(), 9931104, 1019, 2013, "attr-value-del", 0);
